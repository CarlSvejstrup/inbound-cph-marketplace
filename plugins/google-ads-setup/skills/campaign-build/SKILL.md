...
2026-06-03); Editor-CSV'er genereres SENERE af `google-ads-general`-konverteren fra den bekræftede Excel.
...
- Næste skridt (manuelt, human-in-the-loop): workbook → kunde-godkendelse → `google-ads-general`-
  konverteren laver Editor-CSV'erne → mennesket importerer og enabler først når alle Must-pass-gates er
  grønne.
