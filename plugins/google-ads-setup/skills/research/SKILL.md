...
> Når research kaldes via campaign-build-orchestratoren er AI Context allerede hentet og videregivet — så er dette trin et no-op; kør det kun når research kaldes standalone.
