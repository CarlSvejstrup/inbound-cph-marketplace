#!/usr/bin/env python3
"""Build the inb-ads-onboarding-analysis DELIVERABLE: a .docx checklist report for a new client's
...
the client-facing audit (the `inb-ads-account-audit` skill); this is the internal
...
def main():
    ap = argparse.ArgumentParser(description="Build inb-ads-onboarding-analysis .docx report")
