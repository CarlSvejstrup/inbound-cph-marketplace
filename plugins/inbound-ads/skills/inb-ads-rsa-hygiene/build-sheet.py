#!/usr/bin/env python3
"""Build the inb-ads-rsa-hygiene diagnostic workbook (.xlsx).
...
The angle-gap output is the gap-brief fed back into inb-ads-rsa-copy to write
...
Input JSON schema (lists may be empty; missing keys render blank):
{
  ...
  // Synthesised gap-brief for inb-ads-rsa-copy (angles missing a served asset, per ad group).
  "gap_brief": [
