...
This is the deterministic tail of the conversational `inb-ads-search-term-analyse` skill. The CONVERSATION decides
...
The column contracts follow Google Ads Editor's verified bulk-upload schemas. Editor imports CSV
only (not .xlsx).
...
if __name__ == "__main__":
    ...
    slug = args.slug or f"Søgeterm - {_s(data.get('client')) or 'konto'}"
