...
er beskrevet fuldt ud her, så ingen ekstern fil er nødvendig; forfattere kan læse den dybere
vejledning i `inbound-skill-creator`). Led med svaret, gør det skanbart, skjul plumbing (GAQL,
`cost_micros`, view-navne). To formater: spørg én gang "som side eller i chatten?" (eller brug det
brugeren allerede sagde). "Side" bygger en delbar artifact-side i Inbound-husstil (skabelon:
...
6. **Datagrundlag:** footer med vindue, tærskel, "trak X termer", hvilke MCP-kald (kort, ikke en logliste).
