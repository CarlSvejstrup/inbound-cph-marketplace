---
name: search-term
description: Samtale-drevet søgeterm-gennemgang af én LIVE Google Ads-konto. Starter med præcis det samme strukturerede intake som soegeterm-analyse (klient + customer_id, vindue, scope, tærskel, hvilke konverteringer tæller), henter + slanker rapporten, og kører så N-gram + match-type/struktur + tracking-anomalier + konkurrent/off-offering analyse. MEN i stedet for at aflevere en statisk liste, FØRER den en samtale - "hey, kig på det her, overvej det her" - og I beslutter SAMMEN hvilke negatives og nye keywords der skal med. Bring også dine egne interessante fund op, ikke kun de deterministiske. Når I er enige, skriver den direkte de aftalte beslutninger ud i Google Ads Editor-import-klare CSV'er (negatives og/eller nye keywords; flere filer → én zip). Læser kun (read-only mod Google Ads, skriver ALDRIG til kontoen). 0 konverteringer er IKKE bevis for spild på konti hvor folk ringer. Brug når brugeren siger "search term", "søgeterm-samtale", "lad os gå søgetermerne igennem sammen", "diskutér søgetermerne", "find negatives og keywords og lav CSV'er", eller vil tale sig frem til beslutningerne frem for at få en færdig liste. Svarer på dansk.
---
